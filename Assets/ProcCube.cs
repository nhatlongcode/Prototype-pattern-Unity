...
public class ProcCube: Object
{
    ...
    public static GameObject CloneCube(Vector3 pos)
    {
        if (cube == null)
        {
            CreateCube(pos);
        ...
        GameObject CloneCube = new GameObject();

        CloneCube.AddComponent<MeshFilter>();
        CloneCube.AddComponent<MeshRenderer>();
        CloneCube.GetComponent<MeshFilter>().mesh = cube.GetComponent<MeshFilter>().mesh;
        CloneCube.GetComponent<MeshRenderer>().material = cube.GetComponent<MeshRenderer>().material;
        CloneCube.AddComponent<Rigidbody>();
        CloneCube.AddComponent<BoxCollider>();
        CloneCube.name = "Cube(Clone)";
        CloneCube.transform.position = pos;
        CloneCube.SetActive(true);
        return CloneCube;

    }

    public static GameObject CloneSphere(Vector3 pos)
    {
        if (sphere == null)
        {
            CreateSphere(pos);
        ...
        GameObject CloneSphere = new GameObject();

        CloneSphere.AddComponent<MeshFilter>().mesh = sphere.GetComponent<MeshFilter>().mesh;
        CloneSphere.AddComponent<MeshRenderer>().material = sphere.GetComponent<MeshRenderer>().material;

        CloneSphere.AddComponent<Rigidbody>();
        CloneSphere.AddComponent<SphereCollider>();

        CloneSphere.name = "Sphere(Clone)";
        CloneSphere.transform.position = pos;

        CloneSphere.SetActive(true);
    ...
    public static void CreateCube(Vector3 pos)
    {
        ...
        MeshRenderer meshRend = cube.GetComponent<MeshRenderer>();
        meshRend.material = new Material(Shader.Find("Holistic/Plasma"));
